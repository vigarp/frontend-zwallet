        ...
        <aside className="bg-white rounded w-25 d-flex flex-column justify-content-between p-3 me-3">
            <div className="sidebar-upper">
                <div className="row p-3">
                    <div className="col flex-grow-0 p-0 marker-icon"><img src={require("../../../assets/img/icons/marker_homepage.svg").default} alt="" /></div>
                    <div className="col flex-grow-0 py-1"><img src={require("../../../assets/img/icons/grid_homepage_active.svg").default} alt="" /></div>
                    <div className="col fw-bold text-primary py-1 dashboard-pointer"><Link to={"/main"} style={{ textDecoration: 'none' }}>Dashboard</Link></div>
                </div>
                <div className="row p-3">
                    <div className="col flex-grow-0 "><img src={require("../../../assets/img/icons/arrowup_homepage.svg").default} alt="" /></div>
                ...
                <div className="row p-3">
                    <div className="col flex-grow-0"><img src={require("../../../assets/img/icons/plus_homepage.svg").default} alt="" /></div>
                ...
                <div className="row p-3">
                    <div className="col flex-grow-0"><img src={require("../../../assets/img/icons/user_homepage.svg").default} alt="" /></div>
            ...
            <div className="sidebar-lower">
                <div className="row p-3">
                    <div className="col flex-grow-0"><img src={require("../../../assets/img/icons/logout_homepage.svg").default} alt="" /></div>
